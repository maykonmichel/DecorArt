            ...
            <div id="my-account">
            	<form method="post" action="update-account.php" id="frm-signup">
                        ...
                        <div class="field">
                            <label for="email"><span class="fa fa-envelope-o fa-2x left-align" title="Email*"></span></label>
                                <input class="left-align"
                                    ...
                                    <?php echo isset($_GET['edit']) ? "required" : "disabled" ?>>
                    ...
                    <div class="category">
                        ...
                        <div class="field">
                            <label for="name" title="Nome"><span class="fa fa-user fa-2x left-align"></span></label>
                                <input class="left-align"
                                    type="text"
                                    name="name"
                                    id="name"
                                    ...
                                    <?php echo isset($_GET['edit']) ? "required" : "disabled" ?>>
                            <label for="last-name" title="Sobrenome"><span class="fa fa-user fa-2x right-align"></span></label>
                                <input class="right-align"
                                    type="text"
                                    name="last_name"
                                    id="last_name"
                        ...
                        <div class="field">
                            <label for="gender"><span class="fa fa-venus-mars fa-2x left-align"></span></label>
                                <div class="input-area left-align <?php echo isset($_GET['edit']) ? "required" : "disabled" ?>">
                                    Gênero*
                                    <input type="radio"
                                    	name="genre"
                                        id="m"
                                        value="m" 
                                        title="Masculino"
                                		<?php if($_SESSION['genre']=='m') echo "checked" ?>
                              			<?php echo isset($_GET['edit']) ? "required" : "disabled" ?>>
                                    ...
                                    <input type="radio"
                                        ...
                                        value="f"
                                        title="Feminino"
										<?php if($_SESSION['genre']=='f') echo "checked" ?>
                                        <?php echo isset($_GET['edit']) ? "required" : "disabled" ?>>
                                        <label for="f">Feminino</label>
                                </div>
                            <label for="birthday">
                            	<span class="fa fa-birthday-cake fa-2x right-align" id="lblBirthday" title="Data de nascimento*"></span>
                            </label>
                                <input class="right-align"
                                    type="text"
                                    id="birthday"
                        ...
                        <div class="field">
                            <label for="rg" title="R.G."><span class="fa fa-credit-card fa-2x left-align"></span></label>
                                <input class="left-align"
                                    type="text"
                                    id="rg"
                                    name="rg"
                        ...
                        <div class="field">
                            <label for="telephone" title="Telefone"><span class="fa fa-phone fa-2x left-align"></span></label>
                                <input class="left-align"
                                    type="text"
                                    id="telephone"
                                    name="telephone"
                                    ...
                                    <?php echo isset($_GET['edit']) ? "required" : "disabled" ?>>
                            <label for="cellphone" title="Celular"><span class="fa-mobile fa fa-2x right-align"></span></label>
                                <input class="right-align"
                                    type="text"
                                    id="cellphone"
                                    name="cellphone"
                                    ...
                                    title="Celular"
                                    placeholder="Celular"
                                    value="<?php echo $_SESSION['cellphone']; ?>"
                                    <?php echo isset($_GET['edit']) ? "" : "disabled" ?>>
                        </div>
                    </div>
                    <div class="category">
                        <h1>Endereço</h1>
                        <div class="field">
                            <label for="address" title="Endereço"><span class="fa fa-road fa-2x left-align"></span></label>
                                <input class="left-align" 
                                    type="text"
                                    id="address"
                                    name="address"
                        ...
                        <div class="field">
                            <label for="neighborhood" title="Bairro"><span class="fa fa-map fa-2x left-align"></span></label>
                                <input class="left-align"
                                    type="text"
                                    id="neighborhood"
                                    name="neighborhood"
                                    ...
                                    <?php echo isset($_GET['edit']) ? "required" : "disabled" ?>>
                            <label for="complement" title="Complemento"><span class="fa fa-plus fa-2x right-align"></span></label>
                                <input class="right-align"
                                    type="text"
                                    id="complement"
                                    name="complement"
                        ...
                        <div class="field">
                            <label for="city" title="Cidade"><span class="fa fa-map-signs fa-2x left-align"></span></label>
                                <input class="left-align"
                                    type="text"
                                    id="city"
                                    name="city"
                            ...
                            <label for="state"><span class="fa fa-map-o fa-2x left-align small-label" title="UF*" id="lblState"></span></label>
                                <input class="left-align small"
                                    ...
                                    <?php echo isset($_GET['edit']) ? "required" : "disabled" ?>>
                            <label for="cep" title="C.E.P."><span class="fa fa-map-marker fa-2x right-align"></span></label>
                                <input class="right-align small"
                                    type="text"
                                    id="cep"
                                    name="cep"
                    ...
                    <?php
						if(isset($_GET['edit']))
                    		echo '
								<input type="submit" class="signup right-align" value="Salvar">
							';
					?>
                </form>
                <?php
					if(isset($_GET['edit'])) {
						if($_GET['id'])
							...
							$cancel = 'my-account.php';
						echo '
							<input type="submit" class="signup right-align" onClick="location.href=\''.$cancel.'\'" value="Cancelar">
						';
					}
					else {
						echo '
							<input type="submit" class="signup right-align" onClick="location.href=\'my-account.php?edit\'" value="Editar">
						';
					}
				?>
            </div>
