            ...
            <div id="new-account">
                <form method="post" action="signup.php" id="frm-signup">
                    <div class="category">
                        ...
                        <div class="field">
                            <label for="acess"><span class="fa fa-gear fa-2x left-align" title="Acesso*"></span></label>
                            	<select name="acess"
                                	id="acess"
                                    placeholder="Acesso*"
                                    title="Acesso*"
                                    required>
                                    <option value="usuario" label="Usuario" selected></option>
                                    <option value="adm" label="Administrador"></option>
                                </select>
                        	<label for="state_account"><span class="fa fa-power-off fa-2x right-align"></span></label>
                            	<select name="state_account" id="state_account" class="right-align">
                                	<option value="active" label="Ativa"></option>
                                    <option value="inactive" label="Inativa"></option>
                                </select>
                        </div>
                    </div>
                    <div class="category">
                    ...
                    <input type="reset" class="signup" onClick="location.href='user.php'" value="Cancelar">
                </form>
            </div>
